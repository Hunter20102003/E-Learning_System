...
public class OTP_Email extends HttpServlet {
 ...
 public String sendLockCourseEmail(String mail, String courseName) {
        ...
        try {
            ...
            message.setText(String.format("The course %s has been locked. You can still access your course at My Learning.", courseName));
