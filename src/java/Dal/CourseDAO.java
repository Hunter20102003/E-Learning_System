...
public class CourseDAO extends DBContext {
    ...
    public LessonDBO getLessonByID(String id) {
        ...
        try {
            ...
            while (r.next()) {
                ArrayList<SubLessonDBO> listSubLesson = getListSubLessonByLessonID(r.getInt(1));
                Lesson=new LessonDBO(r.getInt(1), r.getString(2), r.getInt(3), r.getBoolean(4), listSubLesson);
    ...
    public int editSubLesson(String title, String content, String description, int lesson_id, String video_link, long video_duration) {
        int cnt = 0;
        String sql = "insert into SubLesson (title,content,description,lesson_id,video_link,video_duration)\n"
                + "  value(?,?,?,?,?,?)";
        try {
