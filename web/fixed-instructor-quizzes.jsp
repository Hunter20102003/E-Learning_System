...
<!-- Mirrored from learnplus.frontendmatter.com/fixed-instructor-quizzes.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 09 Jun 2018 08:42:43 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <title>Instructor - Quizzes - Fixed layout</title>
    ...
    <div class="container">
        ...
        <div class="media align-items-center">
            <div class="media-body">
                <h1 class="page-heading h2">Quizzes</h1>
            </div>
            <div class="media-right">
                <a href="fixed-instructor-quiz-edit.html" class="btn btn-success">New Quiz <i class="material-icons btn__icon--right">add</i></a>
            </div>
        </div>
        <div class="row">
            <div class="col-md-9">
              ...
              <img src="assets/images/vuejs.png" alt="Card image cap" width="80" class="rounded">
            </a>
                            </div>
                            <div class="media-body">
                        ...
                        <div class="card-footer text-center">
                            <a href="fixed-instructor-review-quiz.html" class="btn btn-primary btn-sm float-left"><i class="material-icons btn__icon--left">playlist_add_check</i> Review <span class="badge text-primary bg-white btn__icon--right">5</span></a>
                            <a href="fixed-instructor-quiz-edit.html" class="btn btn-default btn-sm float-right"><i class="material-icons btn__icon--left">edit</i> Edit </a>
                    ...
                    <div class="card">
                        <div class="card-body media">
                            <div class="media-left">
                                <a href="fixed-instructor-review-quiz.html">
              <img src="assets/images/github.png" alt="Card image cap" width="80" class="rounded">
            </a>
                            </div>
                            <div class="media-body">
                    ...
                    <div class="card">
                        <div class="card-body media">
                            <div class="media-left">
                                <a href="fixed-instructor-review-quiz.html">
              <img src="assets/images/gulp.png" alt="Card image cap" width="80" class="rounded">
            </a>
                            </div>
                            <div class="media-body">
...
<!-- Mirrored from learnplus.frontendmatter.com/fixed-instructor-quizzes.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 09 Jun 2018 08:42:45 GMT -->
</html>