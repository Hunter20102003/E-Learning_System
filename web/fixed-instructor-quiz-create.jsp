    ...
    <div class="container">
            ...
            <div class="card-body">
                <form action="#">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <div class="switch">
                                <input id="cmn-toggle" class="switch-toggle switch-toggle-round" type="checkbox"
                                    checked>
        ...
        <div class="card">
            ...
            <div class="card-header bg-white">
                <a href="#" data-toggle="modal" data-target="#editQuiz" class="btn btn-success">Add Question <i
                ...
                <ul class="list-group list-group-fit nestable-list-plain mb-0">
                    <li class="list-group-item nestable-item">
                        ...
                        <ul class="answers list-group list-group-fit nestable-list-plain mb-0" style="display: none;">
                            <li class="list-group-item nestable-item">A. adsf</li>
                            <li class="list-group-item nestable-item">B. sdfsdfswf</li>
                            <li class="list-group-item nestable-item">C. sdfsdfsf</li>
                            <li class="list-group-item nestable-item">D. abcxyz</li>
                        </ul>
                    </li>
        ...
        <div class="footer">
            Copyright &copy; 2016 - <a href="#">SWT301-Team1</a>
        </div>
    </div>
    ...
    <div class="modal fade" id="editQuiz">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header bg-primary" style="background-color: #ff6600;">
                ...
                <div class="modal-body">
                    <form action="#">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <a href="#" class="btn btn-default" id="add-answer-btn"><i
