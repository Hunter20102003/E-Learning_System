                    ...
                    <div class="row">
                        <div class="col-xl-12 col-xxl-12 col-sm-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form action="add_account" method="post" id="emailForm">
                                        <div class="row">
                                         ...
                                         <div class="col-lg-6 col-md-6 col-sm-12">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input name="name" type="text" class="form-control" value="${requestScope.username}">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input name="pas" type="text" class="form-control" value="${requestScope.password}" >
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input name="email" id="email" type="text" class="form-control" value="${requestScope.email}">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input name="fname" type="text" class="form-control" value="${requestScope.firstname}">
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-md-6 col-sm-12">
                                                <div class="form-group">
                                                    <label class="form-label"><strong>Last Name</strong></label>
                                                    <input name="lname" type="text" class="form-control" value="${requestScope.lastname}">
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-md-6 col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <select name="role" class="form-control">
                                                        <option value="1" ${requestScope.role  == 1?"selected":""}>Mentee</option>
                                                        <option value="2" ${requestScope.role  == 2?"selected":""}>Mentor</option>
                                                        <option value="4" ${requestScope.role  == 4?"selected":""}>Manager</option>
