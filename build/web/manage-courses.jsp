                        ...
                        <div id="filterOptions" class="dropdown-menu dropdown-menu-right mt-2" style="display: none;">
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="webDesignCheckbox" value="webDesign">
                                            <label class="form-check-label" for="webDesignCheckbox">Web Design</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="developmentCheckbox1" value="development">
                                            <label class="form-check-label" for="developmentCheckbox1">Development 1</label>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="developmentCheckbox2" value="development">
                                            <label class="form-check-label" for="developmentCheckbox2">Development 2</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="developmentCheckbox3" value="development">
                                            <label class="form-check-label" for="developmentCheckbox3">Development 3</label>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="developmentCheckbox5" value="development">
                                            <label class="form-check-label" for="developmentCheckbox5">Development 5</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="developmentCheckbox6" value="development">
                                ...
                                <div class="price-slider mt-4">
                                    ...
                                    <input type="range" class="form-range" id="priceRange" min="0" max="1000" value="500" step="50">
