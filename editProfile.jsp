...
<body>
    ...
    <div class="container">
        <div class="profile-img">
            <form action="">
            <img src="img/user.jpg" alt="User Image" id="image">
            <input type="file" id="profile-pic" name="profile-pic" onchange="chooseFile(this)" accept="image/png, image/jpeg, image/gif">
        ...
        <form class="edit-profile-form" action="/update_profile" method="post" enctype="multipart/form-data">
            ...
            <div>
                ...
                <input type="text" id="fullname" name="fullname" value="Mr.johndoe">
            </div>
            <div>
